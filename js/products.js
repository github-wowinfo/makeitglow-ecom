									...
									<a href="./productDetails.html?Id=${product.itemEntryId}">
										...
										<div class="shop-meta">
											<a href="javascript:void(0);" class="btn btn-secondary btn-icon"
												data-bs-toggle="modal" class="open-quick-view" data-bs-target="#quickViewModal" onclick="quckview(${product.itemEntryId})">
											...
											<div class="btn btn-primary meta-icon dz-carticon" id="addToCartButton" onclick="addToCart(${product.vrnts[0].vrntEntryId})">
