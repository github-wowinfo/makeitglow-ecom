...
var MoonCartCarousel = function(){
	...
	var handleQuickModal = function() {	
		if(jQuery('.quick-modal-swipers').length > 0){
			var swiper = new Swiper(".quick-modal-swipers", {
			  spaceBetween: 15,
			  slidesPerView: 4,
			  freeMode: true,
			  watchSlidesProgress: true,
			});
			var swiper2 = new Swiper(".quick-modal-swipers3", {
				spaceBetween: 0,
				updateOnWindowResize: true,	
				navigation: {
					nextEl: ".gallery-button-next",
...
//   accordian for events page dropdown.. 
